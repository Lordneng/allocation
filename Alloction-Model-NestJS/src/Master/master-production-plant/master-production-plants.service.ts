...
@Injectable()
export class MasterProductionPlantsService {

  constructor(
    //@InjectModel('MasterCost') private readonly dataModel: Model<MasterCost>
    @Inject(TOKENS.ProjectRepositoryToken) private readonly dataModel: Repository<MasterProductionPlant>
  ) {
  ...
  // }
  @Transaction()
  async create(@TransactionRepository(MasterProductionPlant) manager: Repository<MasterProductionPlant>, data?: any) {
