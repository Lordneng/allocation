...
@Injectable()
export class MasterRefinerysService {

  constructor(
    //@InjectModel('MasterCost') private readonly dataModel: Model<MasterCost>
    @Inject(TOKENS.ProjectRepositoryToken) private readonly dataModel: Repository<MasterRefinery>
  ) {
  ...
  // }
  @Transaction()
  async create(@TransactionRepository(MasterRefinery) manager: Repository<MasterRefinery>, data?: any) {
