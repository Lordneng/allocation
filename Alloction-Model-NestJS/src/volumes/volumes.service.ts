...
import { Volume, VolumeVersion } from './entity';
...
export class VolumesService {
  ...
  constructor(
    @Inject(TOKENS.ProjectRepositoryToken) private readonly dataModel: Repository<Volume>,
    @Inject(TOKENS.ProjectRepositoryTokenVersion) private readonly dataVersionModel: Repository<VolumeVersion>,
  ) {
  ...
  @Transaction()
  async create(@TransactionRepository(Volume) manager: Repository<Volume>, data?: any) {
  ...
  @Transaction()
  async createVersion(@TransactionRepository(VolumeVersion) manager: Repository<VolumeVersion>, data?: any) {
    return await manager.save(data);
  }
...
// import { VolumeVersion } from './models/volume-version';
// @Injectable()
// export class VolumesService {

//   constructor(@InjectModel('Volume') private readonly dataModel: Model<Volume>,
//     @InjectModel('VolumeVersion') private readonly dataVersionModel: Model<VolumeVersion>) {
