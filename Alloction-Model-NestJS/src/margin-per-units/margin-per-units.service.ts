...
import { MarginPerUnit, MarginPerUnitVersion } from './entity';
import { TOKENS } from '../constants';
import console = require('console');
@Injectable()
export class MarginPerUnitsService {

  constructor(
    @Inject(TOKENS.ProjectRepositoryToken) private readonly dataModel: Repository<MarginPerUnit>,
    @Inject(TOKENS.ProjectRepositoryTokenVersion) private readonly dataVersionModel: Repository<MarginPerUnitVersion>,
  ) {
  ...
  @Transaction()
  async create(@TransactionRepository(MarginPerUnit) manager: Repository<MarginPerUnit>, data?: any) {
  ...
  @Transaction()
  async createVersion(@TransactionRepository(MarginPerUnitVersion) manager: Repository<MarginPerUnitVersion>, data?: any) {
    return await manager.save(data);
  }
...
//   constructor(
//     @InjectModel('MarginPerUnit') private readonly dataModel: Model<MarginPerUnit>,
//     @InjectModel('MarginPerUnitVersion') private readonly dataVersionModel: Model<MarginPerUnitVersion>
//     ) {
