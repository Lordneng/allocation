...
{
    public class ReadSellingPriceOutputTemplate : IReadSellingPriceOutputTemplate
    {
        private string _path = string.Empty;
        private ISellingPriceOutputTemplate _outputTemplate;
        private ISellingPriceOutputTemplate.IParameters _outputTemplateParameters;
        private List<ISellingPriceOutputTemplate> outputTemplateList;

        public ReadSellingPriceOutputTemplate(ISellingPriceOutputTemplate outputTemplate,
            ISellingPriceOutputTemplate.IParameters outputTemplateParameters, string path)
        {
        ...
        public void ReadTemplateFile()
        {
            ...
            outputTemplateList = new List<ISellingPriceOutputTemplate>();
            foreach (var item in template.SelectTokens("$..item"))
            {
                var outputParameterList = new List<ISellingPriceOutputTemplate.IParameters>();
