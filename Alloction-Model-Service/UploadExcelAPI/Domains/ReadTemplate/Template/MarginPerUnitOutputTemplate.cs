...
{
    public class MarginPerUnitOutputTemplate : IMarginPerUnitOutputTemplate
    {
        ...
        private IEnumerable<IMarginPerUnitOutputTemplate.IParameters> _parameters { get; set; }
        ...
        {
            return new MarginPerUnitOutputTemplate()
            {
        ...
        public class Parameters : IMarginPerUnitOutputTemplate.IParameters
        {
