...
{
    public class RevenueMBOutputTemplate : IRevenueMBOutputTemplate
    {
        ...
        private IEnumerable<IRevenueMBOutputTemplate.IParameters> _parameters { get; set; }
        ...
        {
            return new RevenueMBOutputTemplate()
            {
        ...
        public class Parameters : IRevenueMBOutputTemplate.IParameters
        {
