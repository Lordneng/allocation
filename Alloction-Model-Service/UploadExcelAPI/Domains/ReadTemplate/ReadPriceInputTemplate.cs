...
{
    public class ReadPriceInputTemplate : IReadPriceInputTemplate
    {
        private string _path = string.Empty;
        private IPriceInputTemplate _inputTemplate;
        private IPriceInputTemplate.IItem _inputTemplateItem;

        public ReadPriceInputTemplate(IPriceInputTemplate inputTemplate, IPriceInputTemplate.IItem inputTemplateItem, string path)
        {
