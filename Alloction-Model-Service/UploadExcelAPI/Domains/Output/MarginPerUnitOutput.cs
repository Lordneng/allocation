...
{
    public class MarginPerUnitOutput : IOutput, IMarginPerUnitOutputConstructor
    {
        [BsonId]
        ...
        public class MarginPerUnitOutputItem : IOutput.IItem
        {
            ...
            {
                return new MarginPerUnitOutputItem()
                {
                    Month = month,
                    Year = year,
                    Value = value
        ...
        {
            return new MarginPerUnitOutput()
            {
