...
{
    public class ExportSellingPriceOutput : IExportOutput
    {
        private IReadInputMapping _readMapping;
        private IReadSellingPriceOutputTemplate _readOutputTemplate;
        ...
        private ISellingPriceOutputConstructor _sellingPriceOutputConstructor;
        private string _collectionName;

        public ExportSellingPriceOutput(
            IReadInputMapping readMapping, IReadSellingPriceOutputTemplate readOutputTemplate, 
            IDatasource<IInput> datasourceInput, IDatasource<IOutput> datasourceOutput, ISellingPriceOutputTemplate outputTemplate,
            ISellingPriceOutputConstructor sellingPriceOutputConstructor, IOutput.IItem outputItem,
            string collectionName)
        {
            ...
            _sellingPriceOutputConstructor = sellingPriceOutputConstructor;
        ...
        public void ExportOutput()
        {
            ...
            foreach (var item in _readOutputTemplate.GetOutputTemplateList())
            {
                ...
                listItem.Add(_sellingPriceOutputConstructor.CreateInstance(version, DateTime.Now,
