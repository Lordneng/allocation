...
{
    public class ExportMarginPerUnitOutput : IExportOutput
    {
        private IReadInputMapping _readMapping;
        private IReadMarginPerUnitOutputTemplate _readOutputTemplate;
        private IDatasource<IOutput> _datasourceInput;
        private IDatasource<IOutput> _datasourceOutput;
        private IOutput.IItem _outputItem;
        private IMarginPerUnitOutputConstructor _marginPerUnitOutputConstructor;
        private string _collectionName;

        public ExportMarginPerUnitOutput(
            IReadInputMapping readMapping, IReadMarginPerUnitOutputTemplate readOutputTemplate, 
            IDatasource<IOutput> datasourceInput, IDatasource<IOutput> datasourceOutput, IMarginPerUnitOutputTemplate outputTemplate,
            IMarginPerUnitOutputConstructor marginPerUnitOutputConstructor, IOutput.IItem outputItem,
            string collectionName)
        {
            ...
            _marginPerUnitOutputConstructor = marginPerUnitOutputConstructor;
        ...
        public void ExportOutput()
        {
            ...
            var cacheParameter = new List<OutputParameterValue>();
            foreach (var item in _readOutputTemplate.GetOutputTemplateList())
            {
                ...
                var parameters = new Dictionary<string, OutputParameterValue>();
                foreach (var parameter in item.GetParameters())
                {
                    ...
                    else
                    {
                        ...
                        var param = new OutputParameterValue()
                        {
                ...
                listItem.Add(_marginPerUnitOutputConstructor.CreateInstance(version, DateTime.Now,
