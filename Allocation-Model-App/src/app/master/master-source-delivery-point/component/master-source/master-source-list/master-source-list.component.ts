...
@Component({
  selector: 'app-master-source-list',
  templateUrl: './master-source-list.component.html',
  styleUrls: ['./master-source-list.component.css']
})
export class MasterSourceListComponent implements OnInit {
  ...
  constructor(
    ...
    private dataService: MasterSourceService,
  ...
  retrieveMasterData(): Observable<any> {
    const masterSource = this.dataService.getList();
    return forkJoin([masterSource]);
  }
  ...
  editClick($event: any, itemData: any) {
    console.log("this.dataPlantList :: ", this.dataPlantList);
    if ($event && itemData) {
