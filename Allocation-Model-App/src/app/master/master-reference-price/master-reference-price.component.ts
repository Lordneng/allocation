...
@Component({
  selector: 'app-master-reference-price',
  templateUrl: './master-reference-price.component.html',
  styleUrls: ['./master-reference-price.component.css']
})
export class MasterReferencePriceComponent implements OnInit {
  dataList: any = []
  ...
  constructor(
    private dataService: MasterReferencePricesService,
