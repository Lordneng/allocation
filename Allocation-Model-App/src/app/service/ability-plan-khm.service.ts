...
export class AbilityPlanKhmService {
  ...
  url = environment.apiUrlNestJS + 'ability-plan-khm/';
  constructor(
  ...
  getaAbilityKhmMonthly(year: any, month: any) {
    // tslint:disable-next-line: arrow-return-shorthand
    return this.http
      .get(this.url + 'ability-khm-monthly',{ params: { year: year, month: month } })
      .pipe(catchError(this.errorMethod));
  }
