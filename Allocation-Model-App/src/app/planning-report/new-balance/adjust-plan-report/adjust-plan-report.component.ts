...
@Component({
  selector: 'app-adjust-plan-report',
  templateUrl: './adjust-plan-report.component.html',
  styleUrls: ['./adjust-plan-report.component.css'],
})
export class AdjustPlanReportComponent implements OnInit {
  ...
  getWorkSheet(workbook: Workbook){
    ...
    let worksheet = workbook.addWorksheet('ปรับแผนจำหน่าย');
