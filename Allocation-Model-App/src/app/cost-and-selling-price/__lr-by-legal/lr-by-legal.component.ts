...
export class LRByLegalComponent implements OnInit {
  ...
  onSave() {
    ...
    let versionNumber = (this.maxVersion ? this.maxVersion : 0);
    ...
    versionNumber = (monthVersion == 13 ? 0 : (this.maxVersion ? this.maxVersion : 0));
  ...
  saveData(datasave, textConfirm, versionName, saveNewVersion, versionNameNew, monthVersion) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        dataVersion.version = (this.maxVersion ? this.maxVersion : 0);
        dataVersion.versionForm = (this.maxVersion ? this.maxVersion : 0);
