...
@Component({
    selector: 'app-volume-selling-price',
    templateUrl: './volume-selling-price.component.html',
    styleUrls: ['./volume-selling-price.component.css']
})
export class VolumeSellingPriceComponent implements OnInit {
    dataList: any = [];
    listMonth = [];
