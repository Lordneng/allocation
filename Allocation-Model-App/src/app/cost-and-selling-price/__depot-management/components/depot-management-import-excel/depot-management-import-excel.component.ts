...
@Component({
  selector: 'app-depot-management-import-excel',
  templateUrl: './depot-management-import-excel.component.html',
  styleUrls: ['./depot-management-import-excel.component.css']
})
export class DepotManagementImportExcelComponent implements OnInit {
